...
<head>
    ...
    <link rel="stylesheet" href="<%=baseUrl%>/ztree/zTreeStyle.css" type="text/css">
    <link rel="stylesheet" href="<%=baseUrl%>/assets/css/bootstrap-duallistbox.min.css" type="text/css">

    <script type="text/javascript" src="<%=baseUrl%>/ztree/jquery.ztree.all.min.js"></script>
    <script type="text/javascript" src="<%=baseUrl%>/assets/js/jquery.bootstrap-duallistbox.min.js"></script>
    <style type="text/css">
