...
import com.kevin.param.SearchLogParam;
    ...
    public void recover(int id){
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_ROLE_USER:
                ...
                sysRoleUserService.changeRoleUsers(sysLog.getTargetId(), JsonMapper.stringToObject(sysLog.getOldValue(), new TypeReference<List<Integer>>() {
                }));
                break;
            default:;
        }
